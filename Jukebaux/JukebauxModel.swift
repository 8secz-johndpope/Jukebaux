...
class JukebauxModel {
    ...
    // R: 149 G: 83 B: 207
    var mainJukebauxColor = UIColor(red: 149.0/255.0, green: 83.0/255.0, blue: 207.0/255.0, alpha: 1)
    var mainJukebauxColorInt = 9786319
    
    //87 115 227
    var secondaryJukebauxColor = UIColor(red: 87.0/255.0, green: 115.0/255.0, blue: 227.0/255.0, alpha: 1)
    
    //singleton
    static var shared = JukebauxModel()
