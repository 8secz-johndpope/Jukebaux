...
//        }
    ...
    func applicationDidEnterBackground(_ application: UIApplication) {
        ...
        if JukebauxModel.shared.currentPartyIndex < JukebauxModel.shared.parties.count {
            let party = JukebauxModel.shared.parties[JukebauxModel.shared.currentPartyIndex]
